SUPREME Random Dot Motion Experiment
====================================
These are the SMILE files for the RDM task paradigm included in *SUPREME*
(Sensing to Understanding and Prediction Realized via an Experiment and Modeling
Ecosystem). In order to generate data for the RDM model included within the
